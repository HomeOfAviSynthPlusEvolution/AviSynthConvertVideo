...
| resize-431 | Y8 | 1920×1080 | `src.SincLin2Resize(2880,1620)` | 6.1501 / 9.3480 / 1.520 | 7.1435 / 6.7783 / 0.949 | True / True | 3 / 3 |
...
| resize-434 | Y16 | 1920×1080 | `src.SincLin2Resize(2880,1620)` | 7.0710 / 8.4701 / 1.198 | 7.4358 / 6.4249 / 0.864 | True / True | 3 / 3 |
...
| route=RGB-YUV; bits=16; precision=20; source_full=1; destination_full=1; width=960; height=540 | AVX2 | unavailable | 1.2079 | unavailable | unavailable | High-precision API; three rounds of continuous batches, exact C. No saved upstream counterpart. |
| route=RGB-YUV; bits=16; precision=20; source_full=1; destination_full=1; width=960; height=540 | AVX3_ZEN4 | unavailable | 0.5571 | unavailable | unavailable | High-precision API; three rounds of continuous batches, exact C. No saved upstream counterpart. |
| route=RGB-YUV; bits=16; precision=20; source_full=1; destination_full=1; width=1920; height=1080 | AVX2 | unavailable | 4.8490 | unavailable | unavailable | High-precision API; three rounds of continuous batches, exact C. No saved upstream counterpart. |
| route=RGB-YUV; bits=16; precision=20; source_full=1; destination_full=1; width=1920; height=1080 | AVX3_ZEN4 | unavailable | 2.2526 | unavailable | unavailable | High-precision API; three rounds of continuous batches, exact C. No saved upstream counterpart. |
...
| route=YUV-RGB; bits=16; precision=20; source_full=1; destination_full=1; width=960; height=540 | AVX2 | unavailable | 1.1989 | unavailable | unavailable | High-precision API; three rounds of continuous batches, exact C. No saved upstream counterpart. |
| route=YUV-RGB; bits=16; precision=20; source_full=1; destination_full=1; width=960; height=540 | AVX3_ZEN4 | unavailable | 0.5578 | unavailable | unavailable | High-precision API; three rounds of continuous batches, exact C. No saved upstream counterpart. |
| route=YUV-RGB; bits=16; precision=20; source_full=1; destination_full=1; width=1920; height=1080 | AVX2 | unavailable | 4.8410 | unavailable | unavailable | High-precision API; three rounds of continuous batches, exact C. No saved upstream counterpart. |
| route=YUV-RGB; bits=16; precision=20; source_full=1; destination_full=1; width=1920; height=1080 | AVX3_ZEN4 | unavailable | 2.2526 | unavailable | unavailable | High-precision API; three rounds of continuous batches, exact C. No saved upstream counterpart. |
